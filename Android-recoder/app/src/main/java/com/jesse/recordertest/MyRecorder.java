...
public class MyRecorder {
	...
	private final long cMaxFileSizeInBytes = 50 * 1000*1000;
	...
	public boolean startRecording() {
		...
		try {
			...
			DirUtils.puResolutionChoice = SettingsDialog.cpuRes1280;
			...
			prMediaRecorder.setVideoEncodingBitRate(30000000);
			...
			try {
				...
				Log.e("James", e.toString()+"---"+e.getMessage());
			}
